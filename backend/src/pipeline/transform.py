...
def transform_top_items(items: list[dict], item_type: str, time_range: str) -> list[dict]:
        ...
        results.append(
            {
                ...
                "image_url": _first_image(
                    item.get("images") or item.get("album", {}).get("images")
                ),
...
TAG_MOOD_MAP: dict[str, dict[str, float]] = {
    ...
    "hard": {"energy": 0.8},
    "chill": {"energy": 0.2, "valence": 0.5},
    "mellow": {"energy": 0.2},
    "calm": {"energy": 0.15},
    "ambient": {"energy": 0.1, "instrumentalness": 0.7},
    "relaxing": {"energy": 0.15, "valence": 0.5},
    # valence
    "happy": {"valence": 0.9, "energy": 0.7},
    "upbeat": {"valence": 0.85, "energy": 0.75},
    "feel good": {"valence": 0.9},
    "uplifting": {"valence": 0.85},
    "sad": {"valence": 0.1, "energy": 0.25},
    "melancholy": {"valence": 0.15},
    "dark": {"valence": 0.1, "energy": 0.5},
    "depressing": {"valence": 0.05},
    # danceability
    "dance": {"danceability": 0.9, "energy": 0.7},
    "party": {"danceability": 0.9, "energy": 0.85},
    "groovy": {"danceability": 0.85},
    "funky": {"danceability": 0.85, "energy": 0.7},
    "club": {"danceability": 0.9, "energy": 0.8},
    # acousticness
    "acoustic": {"acousticness": 0.9},
    "folk": {"acousticness": 0.7},
    "unplugged": {"acousticness": 0.85},
    # instrumentalness
    "instrumental": {"instrumentalness": 0.9},
    "post-rock": {"instrumentalness": 0.6},
    # speechiness
    "rap": {"speechiness": 0.8},
    "hip-hop": {"speechiness": 0.7},
    "spoken word": {"speechiness": 0.9},
    # liveness
    "live": {"liveness": 0.9},
    "concert": {"liveness": 0.85},
}
